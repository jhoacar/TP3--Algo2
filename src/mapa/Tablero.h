...
class Tablero
{
	...
	public:
		...
		//Pre: Un ID valido
		//Post: devuelve el objeto asociado al id ingresado si es que lo hay
		Objeto* obtener_objeto_id(string ID);
		...
		//Pre: -
		//Post: devuelve una lista con todos los objetos del tablero
