...
template <class Dato>
bool Lista<Dato>::existe(Dato dato,int (*compare)(Dato A , Dato B)=comparacion) const{
...
template <class Dato>
int Lista<Dato>::buscar_dato(int inicio_search,const Dato dato, int (*compare)(Dato A,Dato B)=comparacion) const{
...
template <class Dato>
void Lista<Dato>::ordenar(int (*compare)(const Dato a, const Dato b)=comparacion){
...
template <class Dato>
void Lista<Dato>::limpiar(int (*compare)(const Dato a, const Dato b)=comparacion){
  Lista nueva;
...
template <class Dato>
bool Lista<Dato>::borrar_dato(const Dato dato, int (*compare)(Dato A, Dato B)=comparacion){
  return borrar(buscar_dato(0,dato,compare));
}

template <class Dato>
bool Lista<Dato>::borrar_toda_occurrencia(const Dato dato, int (*compare)(Dato A, Dato B)=comparacion){
...
template <class Dato>
int Lista<Dato>::obtener_cantidad_dato(const Dato dato, int (*compare)(Dato A, Dato B)=comparacion){
...
template <class Dato>
Lista<Dato>* Lista<Dato>::obtener_diferencia(const Lista<Dato> lista, int (*compare)(Dato A, Dato B)=comparacion){
...
template <class Dato>
bool Lista<Dato>::existe_alguno(Lista<Dato> &lista , int(*compare)(Dato A, Dato B)=comparacion){
  bool found = false;
...
template <class Dato>
bool Lista<Dato>::existen_todos(Lista<Dato> &lista , int(*compare)(Dato A, Dato B)=comparacion){
  int cantidad = 0;
...
template <class Dato>
Dato Lista<Dato>::minimo(int (*compare)(Dato A,Dato B)=comparacion){
  Dato minimo,dato;
  if(existe_siguiente())
...
template <class Dato>
Dato Lista<Dato>::maximo(int (*compare)(Dato A,Dato B)=comparacion){
  Dato maximo,dato;
  if(existe_siguiente())
...
template <class Dato>
Lista<Dato>* selection_ordenar(Lista<Dato> &list,int (*compare)(const Dato a, const Dato b)=comparacion){
...
template <class Dato>
Lista<Dato>* quick_ordenar(Lista<Dato> &list,int (*compare)(const Dato a, const Dato b)=comparacion){
