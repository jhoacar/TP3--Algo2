...
//Con las variables enumeradas obtengo una equivalencia (int) de la razon por la que no se puede atacar
enum {SI_ATACA=0, NO_ENERGIA, NO_ARMA_OBJETO, NO_RANGO, NO_MOUNSTRUO}; //Para humano
enum {SI_ATACA_MOUNSTRUO=0, NO_ENERGIA_MOUNSTRUO, NO_RANGO_MOUNSTRUO, NO_HUMANO}; //Para mounstruo
