...
int main() {
    ...
    Coordenada posicion_3(9, 5);
    Casilla *casilla_3 = new Camino(posicion_3);

    Coordenada posicion_4(1, 5);
    ...
    casilla_3-> agregar_objeto(vanesa);
    ...
    bool validacion = ((Cazador *) cazador)->validacion_defensa(5);
    if(validacion)
        ((Ser *) cazador)->defender(2, tablero);
