...
int main() {
    ...
    Objeto *vampiro = new Nosferatu(casilla, 'N', "id");
    ...
    ((Nosferatu *) vampiro)->encuentro_con_elemento();
    Lista<Objeto *> inventario = ((Nosferatu *) vampiro)->obtener_inventario();
