...
int main() {
    ...
    Objeto *vampiro = new Vampiro(casilla, 'v', "id");
    ...
    ((Vampiro *) vampiro)->encuentro_con_elemento();
    Lista<Objeto *> inventario = ((Vampiro *) vampiro)->obtener_inventario();
    ...
    ((Ser *) vampiro)->atacar(casilla1, tablero);
    ...
    cout << "vida vampiro : " << vida_humano_2 << endl;
    cout << "energia vampiro : " << energia_humano_2 << endl;
    cout << "armadura vampiro : " << armadura_humano_2 << endl;
    cout << "fuerza vampiro : " << fuerza_humano_2 << endl;
